...
## Given
- **statement**: Linear systems hold principle of superposition, i.e., both homogeneity and additivity, but nonlinear systems do not hold at least one of homogeneity and additivity

## Derivation Steps
### Step 1: Query tokens

```
['additivity', 'hold', 'homogeneity', 'least', 'linear', 'nonlinear', 'one', 'principle', 'superposition', 'systems']
```
...
### Step 3: Match #1: rule_001 (score=27.0)
...
### Step 4: Match #2: rule_005 (score=21.0)
...
### Step 5: Match #3: rule_002 (score=19.0)
...
- **confidence**: `HIGH`
- **verdict_note**: `규칙(rule_001)과 구조 일치`
...
- **advisory**: `매칭 규칙: A linear system satisfies both homogeneity and additivity (superposition principle).
규칙 verdict: TRUE
추정 판정: TRUE
흔한 함정: Students sometimes confuse 'superposition' as a single condition; it is actually the combination of both homogeneity and additivity.`
- **verdict**: `TRUE`

## Sanity Check
Confidence: HIGH | Score: 27.0 | Conflicts: 0 (0 HIGH) | Rules: 62
