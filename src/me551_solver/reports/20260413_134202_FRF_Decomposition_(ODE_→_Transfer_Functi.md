...
24⋅⎝5⋅s  + s + 20⎠
  ...
  G₂(jω) = (25*I*omega - 20)/(120*omega**2 - 24*I*omega - 480)
...
- **first_order**: `[{'omega_b': 1.0, 'time_constant': 1.0, 'subsystem_tf': '5/(24*(s + 1))', 'G_jw': '-5*I/(24*omega - 24*I)', 'G_jw_real': '5/(24*(omega**2 + 1))', 'G_jw_imag': '-5*omega/(24*omega**2 + 24)'}]`
- **second_order**: `[{'omega_n': 2.0, 'zeta': 0.05, 'subsystem_tf': '-5*(5*s - 4)/(24*(5*s**2 + s + 20))', 'G_jw': '(25*I*omega - 20)/(120*omega**2 - 24*I*omega - 480)', 'G_jw_real': '25*(16 - 5*omega**2)/(24*(25*omega**4 - 199*omega**2 + 400))', 'G_jw_imag': '(125*omega**3 - 520*omega)/(600*omega**4 - 4776*omega**2 + 9600)'}]`
- **pole_real**: `-1.0`
- **bandwidth_G1**: `1.0`
- **omega_n**: `2.0`
- **zeta**: `0.05`
